...
AILegal and medical documents extracted by the OCR service.
...
def summarize_text(text: str) -> str:
    ...
    prompt that primes the model for AILegal and medical document summarisation.
    ...
    chat_response = client.chat.completions.create(
        model="gpt-3.5-turbo",
        messages=[
            # System prompt: establish the model's role as an AILegal/medical summariser
            {"role": "system", "content": "You are a helpful assistant that summarizes AILegal and medical documents."},
